		...
		<MegaMenu>
			...
			<MegaMenuContent>
				<MegaMenuSection title="By Industry">
					<MegaMenuItem
						href="#"
						description="Streamline patient care and records management"
					>
						Healthcare
					</MegaMenuItem>
					<MegaMenuItem
						href="#"
						description="Secure banking and transaction processing"
					>
						Finance
					</MegaMenuItem>
					<MegaMenuItem
						href="#"
						description="E-commerce and inventory solutions"
					>
						Retail
					</MegaMenuItem>
				</MegaMenuSection>
