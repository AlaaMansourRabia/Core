...
const statusDotVariants = cva(
	"wwc:inline-block wwc:shrink-0 wwc:rounded-full",
	{
		variants: {
			variant: {
			...
			shape: {
				...
				minus: "wwc:relative after:wwc:absolute after:wwc:inset-x-0.5 after:wwc:top-1/2 after:wwc:-translate-y-1/2 after:wwc:h-0.5 after:wwc:bg-background after:wwc:rounded-full",
			},
			pulse: {
