...
async function runDry(catalog, tasks) {
	...
	const checks = [
		["A1 exposes deep-path imports (fair baseline)", sys.A1.includes("@core/core-ui/button")],
	...
	const probes = [
		{label: "good (deep import, renders)", task: {expected: ["Button"]}, code: 'import { Button } from "@core/core-ui/button";\nexport default function Demo() {\n  return <Button>Save</Button>;\n}\n'},
		{label: "bad (barrel import)", task: {expected: ["Button"]}, code: 'import { Button } from "@core/core-ui";\nexport default function Demo() {\n  return <Button>Save</Button>;\n}\n'},
	];
	const seen = {};
