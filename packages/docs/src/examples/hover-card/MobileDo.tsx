...
export function MobileDo() {
	return (
		<div className="wwc:space-y-2">
			<div className="wwc:flex wwc:items-center wwc:gap-2">
				...
				<HoverCard>
					<HoverCardTrigger asChild>
						<Button variant="ghost" size="icon" className="wwc:h-6 wwc:w-6" aria-label="Pricing details">
			...
			<p className="wwc:text-xs wwc:text-muted-foreground">Includes unlimited users and 100GB storage</p>
		</div>
	);
}
