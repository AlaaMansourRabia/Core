	...
	return (
		<Accordion type="single" collapsible className="wwc:w-full">
			<AccordionItem value="basic">
				...
				<AccordionContent>Name, email, and contact details.</AccordionContent>
			</AccordionItem>
			<AccordionItem value="advanced">
				<AccordionTrigger>Advanced Settings</AccordionTrigger>
				<AccordionContent>API keys, webhooks, and integrations.</AccordionContent>
			</AccordionItem>
			<AccordionItem value="danger">
				<AccordionTrigger>Danger Zone</AccordionTrigger>
				<AccordionContent>Delete account and data export options.</AccordionContent>
			</AccordionItem>
		</Accordion>
	);
}
