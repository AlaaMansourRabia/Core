...
export function NavigationDo() {
	return (
		<Lightbox>
			...
			<LightboxContent>
				<img src="https://images.unsplash.com/photo-1518837695005-2083093ee35b?w=1200" alt="Image 1 of 5" />
				<LightboxNavigation currentIndex={0} totalImages={5} showThumbnails />
			</LightboxContent>
		</Lightbox>
	);
}
