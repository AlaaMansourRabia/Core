...
import {CanvasToolbar, type CanvasToolbarBlueprint} from "../canvas-toolbar";
import type {DrawingToolId, LineKind, PinKind, ShapeKind} from "../drawing-actions";
 ...
 * own data (see the CoreDesignCanvas template docs in Storybook). Slated for removal from the public API in a
 * future major.
 */
export function DesignCanvas() {
	...
	return (
		<div className="wwc:space-y-12">
			<div>
				<h1 className="wwc:text-3xl wwc:font-bold">Design Canvas</h1>
				<p className="wwc:text-muted-foreground wwc:mt-2">
					A top toolbar over a three-panel resizable split. The side panels collapse from the toolbar or by dragging
					their handle past the minimum size. The center is a canvas surface with a floating toolbar pinned to the
					bottom-center.
				</p>
			</div>

			<div className="wwc:flex wwc:h-[760px] wwc:flex-col wwc:overflow-hidden wwc:rounded-xl wwc:border">
				{/* Top toolbar */}
			...
			<div>
				<h2 className="wwc:text-2xl wwc:font-bold">With the Canvas Toolbar</h2>
				<p className="wwc:text-muted-foreground wwc:mt-2">
					The same three-panel split, with the full{" "}
