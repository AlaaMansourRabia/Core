...
// Same-origin by default: this page is served from core.core.com, where /mcp is the hosted function.
const MCP_URL =
	readEnv("VITE_CORE_MCP_URL") ??
...
4. workspace setup — if needed, create or repair the React + TypeScript app and install @core/core-ui using environment-backed GitHub Packages authentication.
