...
// Core Studio — the read-only front door to Core. Home browses and searches the canonical
// catalog; Preview renders an approved template with the real Core renderer. Studio does not edit,
...
export default function App() {
	...
	// Follow the theme of a host shell (e.g. the Core Hub) when embedded in an
