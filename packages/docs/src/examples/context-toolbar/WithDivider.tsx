...
export function WithDivider() {
	return (
		<ContextToolbar>
			...
			<ContextToolbarButton><Underline className="wwc:h-4 wwc:w-4" /></ContextToolbarButton>
			<ContextToolbarDivider />
			<ContextToolbarButton><AlignLeft className="wwc:h-4 wwc:w-4" /></ContextToolbarButton>
			<ContextToolbarButton><AlignCenter className="wwc:h-4 wwc:w-4" /></ContextToolbarButton>
			<ContextToolbarButton><AlignRight className="wwc:h-4 wwc:w-4" /></ContextToolbarButton>
		</ContextToolbar>
	);
}
