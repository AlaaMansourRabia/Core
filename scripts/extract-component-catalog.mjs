#!/usr/bin/env node
// Read-only structural extractor for the @corensystem/core-ui component catalog.
//
...
//   - the deep-path import specifier  (@corensystem/core-ui/<key>)
...
for (const [expKey, val] of Object.entries(pkg.exports)) {
	...
	const entry = {
		...
		import: `@corensystem/core-ui/${sub}`,
