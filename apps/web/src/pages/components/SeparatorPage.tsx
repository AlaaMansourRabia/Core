		...
		<div className="wwc:space-y-8">
			<div>
				<div className="wwc:group wwc:flex wwc:items-center wwc:gap-3">
					<h1 className="wwc:text-3xl wwc:font-bold">Separator</h1>
					<CopyButton
						value="Separator"
						className="wwc:opacity-0 wwc:group-hover:opacity-100 wwc:focus-visible:opacity-100"
					/>
				</div>
				<p className="wwc:text-muted-foreground wwc:mt-2">Visually or semantically separates content.</p>
			</div>
				...
				<CardContent>
					<div>
						<div className="wwc:space-y-1">
							<h4 className="wwc:text-sm wwc:font-medium wwc:leading-none">Radix Primitives</h4>
							...
							<tbody>
								{[
									...
									},
									{
										...
										type: "boolean",
										def: "true",
										desc: "Whether the separator is purely decorative (hides from accessibility tree).",
									},
