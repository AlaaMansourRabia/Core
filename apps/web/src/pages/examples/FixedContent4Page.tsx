...
export function FixedContent4Page() {
		...
		>
			{!fullscreen && (
				<div className="wwc:flex wwc:items-center wwc:justify-between">
					<div>
						<h1 className="wwc:text-3xl wwc:font-bold">Fixed Content #4</h1>
						<p className="wwc:text-muted-foreground wwc:mt-2">
							Three fixed panels with the middle panel split into three sections, and collapsible side panels.
						</p>
					</div>
			...
			>
				...
				<div className="wwc:flex-1 wwc:flex wwc:flex-col wwc:bg-background wwc:min-w-0">
					...
					<div className="wwc:flex-[1] wwc:border-b wwc:p-4 wwc:pt-3">
					...
					<div className="wwc:flex-[8] wwc:border-b wwc:p-4">
					...
					<div className="wwc:flex-[1] wwc:p-4">
