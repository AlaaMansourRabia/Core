...
import {MOCK_ORGANIZATIONS, getProjectsByOrg} from "@corensystem/coren-ui/data/mock-data";
// Renders any Core template by id (route /templates/:id) — the real @corensystem/coren-ui
...
import {AnalyticsOverview} from "@corensystem/coren-ui/pages/core-analytics-overview";
...
import {BlueprintViewer3} from "@corensystem/coren-ui/pages/core-blueprint-viewer-3";
...
import {DesignCanvas} from "@corensystem/coren-ui/pages/core-design-canvas";
import {LoginPage} from "@corensystem/coren-ui/pages/core-login-page";
import {MapCompareLayout} from "@corensystem/coren-ui/pages/core-map-compare-layout";
import {OrgWorkforceIntelligence} from "@corensystem/coren-ui/pages/core-org-workforce-intelligence";
import {ProgressDetails} from "@corensystem/coren-ui/pages/core-progress-details";
import {ProjectOverview} from "@corensystem/coren-ui/pages/core-project-overview";
import {ProjectRealityCapture} from "@corensystem/coren-ui/pages/core-project-reality-capture";
import {ProjectScheduleCost} from "@corensystem/coren-ui/pages/core-project-schedule-cost";
import {ProjectSetup} from "@corensystem/coren-ui/pages/core-project-setup";
import {ProjectWorkforceSafety} from "@corensystem/coren-ui/pages/core-project-workforce-safety";
import {SafetyManager} from "@corensystem/coren-ui/pages/core-safety-manager";
...
import {WorkPermit} from "@corensystem/coren-ui/pages/core-work-permit";
