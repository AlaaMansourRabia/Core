		...
		<div className="wwc:space-y-8">
			<div>
				<div className="wwc:group wwc:flex wwc:items-center wwc:gap-3">
					<h1 className="wwc:text-3xl wwc:font-bold">Pagination</h1>
					<CopyButton
						value="Pagination"
						className="wwc:opacity-0 wwc:group-hover:opacity-100 wwc:focus-visible:opacity-100"
					/>
				</div>
				<p className="wwc:text-muted-foreground wwc:mt-2">Pagination with page navigation, next and previous links.</p>
			</div>
			...
			<Card>
				<CardHeader>
					<div className="wwc:group wwc:flex wwc:items-center wwc:gap-3">
						...
						<CopyButton
							value="Pagination - API Reference"
							className="wwc:opacity-0 wwc:group-hover:opacity-100 wwc:focus-visible:opacity-100"
						/>
					</div>
					<CardDescription>
								...
								{[
									{
										...
										type: "boolean",
										def: "false",
										desc: "Highlights the link as the current page (PaginationLink).",
									},
									{
										prop: "size",
										type: "ButtonProps['size']",
										def: "'icon'",
										desc: "Button size variant for the link (PaginationLink).",
									},
									{prop: "className", type: "string", def: "-", desc: "Additional CSS classes for the component."},
								].map((row) => (
