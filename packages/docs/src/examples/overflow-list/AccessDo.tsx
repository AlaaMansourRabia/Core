...
export function AccessDo() {
	return (
		<OverflowList maxVisible={2} expandable>
			<OverflowListItem><Badge>Item 1</Badge></OverflowListItem>
			<OverflowListItem><Badge>Item 2</Badge></OverflowListItem>
			<OverflowListItem><Badge>Item 3</Badge></OverflowListItem>
