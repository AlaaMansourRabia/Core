...
import {SiteImageViewer} from "@wakecap/core-ui/site-image-viewer";
import {ALMANAR_SITE_META, ALMANAR_VILLAS, ALMANAR_ZONE_A_BLOCKS} from "@wakecap/core-ui/site-image-viewer-fixtures";
...
// Konva, no map engine. Now shipped as `@wakecap/core-ui/site-image-viewer`; the real villa data is the
// separate `@wakecap/core-ui/site-image-viewer-fixtures` payload.
const meta = {
