...
// Core Connect V1 pairs this admin portal with AppInstaller as the end-user portal.
const meta = {
	title: "Templates/Core Connect/V1/WC3 Workspace",
		...
		docs: {
			page: () => (
				<TemplateDocsPage
					...
					family={
						<>
							Core Connect V1, admin portal. Connect V1 is a two-portal product: this workspace is where an admin
			...
			description: {
				component:
					"The admin portal of Core Connect V1 — the side where an admin manages everything, paired with " +
