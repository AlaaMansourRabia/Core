...
//
// Minimal by design: transpile the snippet (TS/JSX → JS), import it so its `@core/core-ui`
...
// @core/core-ui but 19.x at the repo root, so a naive SSR mixes React-18 elements (from
...
// Resolve react / react-dom from the same place @core/core-ui resolves them (one instance).
