...
import {SiteImageViewer} from "@core/core-ui/site-image-viewer";
import {ALMANAR_SITE_META, ALMANAR_VILLAS, ALMANAR_ZONE_A_BLOCKS} from "@core/core-ui/site-image-viewer-fixtures";
...
// Konva, no map engine. Now shipped as `@core/core-ui/site-image-viewer`; the real villa data is the
// separate `@core/core-ui/site-image-viewer-fixtures` payload.
const meta = {
