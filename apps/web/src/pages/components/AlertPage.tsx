		...
		<div className="wwc:space-y-8">
			<div>
				<div className="wwc:group wwc:flex wwc:items-center wwc:gap-3">
					<h1 className="wwc:text-3xl wwc:font-bold">Alert</h1>
					<CopyButton
						value="Alert"
						className="wwc:opacity-0 wwc:group-hover:opacity-100 wwc:focus-visible:opacity-100"
					/>
				</div>
				<p className="wwc:text-muted-foreground wwc:mt-2">Displays a callout for user attention.</p>
			</div>
								...
								{[
									{
										...
										def: '"default"',
										desc: "Visual style of the alert.",
									},
								].map((row) => (
