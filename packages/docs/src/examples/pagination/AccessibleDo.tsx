	...
	return (
		<Pagination aria-label="Search results pages">
			<PaginationContent>
				...
				<PaginationItem>
					<PaginationLink href="#" aria-label="Page 1">1</PaginationLink>
				</PaginationItem>
				<PaginationItem>
					<PaginationLink href="#" isActive aria-label="Page 2, current page">2</PaginationLink>
				</PaginationItem>
				<PaginationItem>
					<PaginationLink href="#" aria-label="Page 3">3</PaginationLink>
				</PaginationItem>
				<PaginationItem>
