...
import manifest from "../../../../manifests/wakecap-connect.template.json";
import {TemplateDocsPage} from "../_docs/TemplateDocsPage";

// WakeCap Connect V2 — the V1 pair (WC3 Workspace + AppInstaller) merged into one app. One sidebar:
// installed apps, divider, admin perspectives, divider, Marketplace.
const meta = {
	title: "Templates/WakeCap Connect/V2/WakeCap Connect",
	component: WakeCapConnect,
	tags: ["autodocs"],
	parameters: {
		layout: "fullscreen",
		docs: {
			page: () => (
				<TemplateDocsPage
					...
					family={
						<>
							WakeCap Connect V2, unified portal. Where V1 split Connect into an admin portal (
							<code>wc3-workspace</code>) and an end-user portal (<code>app-installer</code>), V2 collapses both into
							one app. Canonical: <code>wakecap-connect</code>. A single CoreAppSidebar, branded "WakeCap Connect",
			...
			description: {
				component:
					"WakeCap Connect V2 — the admin workspace and the app marketplace as one app. The sidebar stacks Home " +
...
} satisfies Meta<typeof WakeCapConnect>;
