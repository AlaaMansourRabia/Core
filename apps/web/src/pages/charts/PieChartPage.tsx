...
export function PieChartPage() {
	return (
		<div className="wwc:space-y-8">
			<div>
				<h1 className="wwc:text-3xl wwc:font-bold">Pie Chart</h1>
			...
			<div className="wwc:grid wwc:gap-6 wwc:md:grid-cols-2">
				<Card>
					<CardHeader className="wwc:pb-2">
						<CardTitle>Basic Pie</CardTitle>
						<CardDescription>Simple pie chart showing proportions</CardDescription>
					</CardHeader>
					<CardContent>
						<ReactECharts
							option={{
				...
				<Card>
					<CardHeader className="wwc:pb-2">
						...
						<CardDescription>Pie chart with a hollow center</CardDescription>
					</CardHeader>
					<CardContent>
						<ReactECharts
							option={{
				...
				<Card>
					<CardHeader className="wwc:pb-2">
						...
						<CardDescription>Nightingale diagram with varying radius</CardDescription>
					</CardHeader>
					<CardContent>
						<ReactECharts
							option={{
				...
				<Card>
					<CardHeader className="wwc:pb-2">
						<CardTitle>Half Doughnut</CardTitle>
						<CardDescription>Semi-circular pie chart</CardDescription>
					</CardHeader>
					<CardContent>
						<ReactECharts
							option={{
