		...
		<div className="wwc:space-y-8">
			...
			<section className="wwc:space-y-3 wwc:rounded-lg wwc:border wwc:p-6">
				<div>
					...
					<p className="wwc:text-sm wwc:text-muted-foreground">
						A collapsible header sits above Core <code className="wwc:text-xs">Tabs</code>. Each tab swaps in its own
						colors and rows, so the legend re-keys itself based on what's selected. The list caps at four rows and
