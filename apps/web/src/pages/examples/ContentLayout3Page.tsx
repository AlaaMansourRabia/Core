...
export function ContentLayout3Page() {
		...
		>
			{!fullscreen && (
				<div className="wwc:flex wwc:items-center wwc:justify-between">
					<div>
						<h1 className="wwc:text-3xl wwc:font-bold">Flexible Content #3</h1>
						<p className="wwc:text-muted-foreground wwc:mt-2">
							Three vertical panels with the middle panel split horizontally into top and bottom sections.
						</p>
					</div>
							...
							topContent={
								<div className="wwc:h-full wwc:p-4 wwc:bg-background">
									...
									<p className="wwc:text-sm wwc:text-muted-foreground">
										Upper content area. Drag the handle below to resize.
									</p>
								</div>
							}
							bottomContent={
								<div className="wwc:h-full wwc:p-4 wwc:bg-background">
									...
									<p className="wwc:text-sm wwc:text-muted-foreground">
										Lower content area. Drag the handle above to resize.
									</p>
								</div>
							}
						/>
