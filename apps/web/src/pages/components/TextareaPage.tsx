		...
		<div className="wwc:space-y-8">
			<div>
				<div className="wwc:group wwc:flex wwc:items-center wwc:gap-3">
					<h1 className="wwc:text-3xl wwc:font-bold">Textarea</h1>
					<CopyButton
						value="Textarea"
						className="wwc:opacity-0 wwc:group-hover:opacity-100 wwc:focus-visible:opacity-100"
					/>
				</div>
				<p className="wwc:text-muted-foreground wwc:mt-2">Displays a form textarea for multi-line text input.</p>
			</div>
			...
			<Card>
				<CardHeader>
					<div className="wwc:group wwc:flex wwc:items-center wwc:gap-3">
						...
						<CopyButton
							value="Textarea - API Reference"
							className="wwc:opacity-0 wwc:group-hover:opacity-100 wwc:focus-visible:opacity-100"
						/>
					</div>
					<CardDescription>
						Extends native{" "}
						<code className="wwc:text-[13px] wwc:bg-muted wwc:px-1.5 wwc:py-0.5 wwc:rounded">{"<textarea>"}</code> HTML
						attributes.
					</CardDescription>
				</CardHeader>
				<CardContent>
								...
								{[
									{
										...
										type: "string",
										def: "-",
										desc: "Placeholder text displayed when the textarea is empty.",
									},
									{prop: "disabled", type: "boolean", def: "false", desc: "Whether the textarea is disabled."},
									{prop: "rows", type: "number", def: "-", desc: "Number of visible text rows."},
									{prop: "value", type: "string", def: "-", desc: "The controlled value of the textarea."},
									{
										prop: "onChange",
										type: "ChangeEventHandler<HTMLTextAreaElement>",
										def: "-",
										desc: "Callback fired when the textarea value changes.",
									},
