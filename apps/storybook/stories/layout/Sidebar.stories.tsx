...
} from "@corensystem/coren-ui/navigation/core-app-sidebar";
import {toneFor} from "@corensystem/coren-ui/tones";
import {
	Blocks,
	Building2,
	CalendarRange,
...
// the fold chevron.
// Tones come from the library's one palette (`@corensystem/coren-ui/tones`) rather than being written out
