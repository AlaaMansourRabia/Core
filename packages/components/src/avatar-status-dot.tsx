...
const avatarStatusDotVariants = cva(
	"wwc:absolute wwc:rounded-full wwc:border-2 wwc:border-background",
	{
		variants: {
			variant: {
		...
		compoundVariants: [
			...
			{
				variant: "dnd",
				class: "wwc:relative after:wwc:absolute after:wwc:inset-x-[2px] after:wwc:top-1/2 after:wwc:-translate-y-1/2 after:wwc:h-0.5 after:wwc:bg-background after:wwc:rounded-full",
			},
...
export interface AvatarStatusDotProps
	extends React.HTMLAttributes<HTMLSpanElement>,
		VariantProps<typeof avatarStatusDotVariants> {
