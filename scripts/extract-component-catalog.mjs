#!/usr/bin/env node
// Read-only structural extractor for the @corensystem/coren-ui component catalog.
//
...
//   - the deep-path import specifier  (@corensystem/coren-ui/<key>)
...
for (const [expKey, val] of Object.entries(pkg.exports)) {
	...
	const entry = {
		...
		import: `@corensystem/coren-ui/${sub}`,
