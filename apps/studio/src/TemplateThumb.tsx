// A live WakeCore thumbnail — the real template compiled + rendered by the WakeCore renderer, scaled
// into a card. These aren't screenshots, they're WakeCore running. Rendered lazily (only when scrolled
...
<body><div id="r"></div><script src="/vendor/wakecore-render.js"></script>
<script>window.addEventListener("message",function(e){if(e&&e.data&&e.data.type==="wc-render"){try{window.WakeCore.renderModule(e.data.code,document.getElementById("r"))}catch(err){}}});</script></body></html>`;
