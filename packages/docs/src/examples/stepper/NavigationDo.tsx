	...
	return (
		<Stepper className="wwc:w-full wwc:max-w-lg">
			<StepperItem status="complete" className="wwc:cursor-pointer">
				...
				<StepperLabel className="wwc:underline wwc:decoration-dotted wwc:underline-offset-4">Account</StepperLabel>
				<StepperSeparator />
			</StepperItem>
			<StepperItem status="complete" className="wwc:cursor-pointer">
				<StepperIndicator>
				...
				<StepperLabel className="wwc:underline wwc:decoration-dotted wwc:underline-offset-4">Payment</StepperLabel>
				<StepperSeparator />
			</StepperItem>
