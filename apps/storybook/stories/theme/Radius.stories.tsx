...
function RadiusStory() {
	return (
		<div className="wwc:space-y-8">
			<div>
				<h2 className="wwc:text-2xl wwc:font-bold">Radius Scale</h2>
				<p className="wwc:text-muted-foreground wwc:mt-1">
					Derived from the base{" "}
					<code className="wwc:bg-muted wwc:px-2 wwc:py-0.5 wwc:rounded">--radius: 0.625rem (10px)</code> CSS variable.
				</p>
			</div>
			...
			<div>
				<h2 className="wwc:text-2xl wwc:font-bold">Component Recommendations</h2>
			</div>
			...
			<div>
				<h2 className="wwc:text-2xl wwc:font-bold">CSS Variable Calculation</h2>
			</div>
...
const meta = {
	...
	parameters: {
		docs: {
			description: {
				component: "Border radius scale derived from the base --radius CSS variable, with component recommendations.",
			},
		},
	},
	render: () => <RadiusStory />,
